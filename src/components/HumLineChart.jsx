...
const HumidityLineChart = ({onDash})=>{
  ...
  useEffect(() => {
    ...
    const lineChartRef = ref(db,`users/${currentUser.currentUser.uid}/dataVisualisation/lineChartHum`);
  ...
  const colors = tokens(theme.palette.mode)
    const dataV =[
        ...
        return (
          ...
          <Box ml={4} mb={-10}>
        <Header title={`${onDash ? "": "Data visualisation"}`} subTitle="The value of Humidity at your Home"/>
        </Box>
                      <ResponsiveLine
            data={dataV}
            theme={{
